...
function App() {
  return (
    <Stack background="black">
      ...
      <Button size="md" fontWeight='semibold' color='#000000' backgroundColor="#f7f7f7" onClick={()=> window.open("https://download1586.mediafire.com/1p7tkyhxlyhg/7wmadnhisacvx73/mods.zip")}>Modları İndir</Button>
